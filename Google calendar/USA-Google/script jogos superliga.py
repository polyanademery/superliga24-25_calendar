...
def adjust_time(date_str, time_str):
    ...
    # Set the start time as the original time
    start_time = dt - timedelta(hours=3) # Timezone
...
# Loop through each game and add to the calendar
for game in games:
...
# Save all events to a single ICS file
with open("Superliga_Feminina_24_25.ics", "w") as f:
    f.writelines(calendar)

print("ICS file created with all games!")